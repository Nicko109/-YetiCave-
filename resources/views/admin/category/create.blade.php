                    ...
                    <div class="col-12">
                        <form class="w-25" action="{{ route('admin.category.actions') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Введите название категории" name="title">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Введите символьный код" name="character_code">
